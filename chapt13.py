...
def compare_mortgages(amt, years, fixed_rate,
                      var_rate1, var_rate2, var_months):
    tot_months = years*12
    fixed1 = Fixed(amt, fixed_rate, tot_months)
    # fixed2 = Fixed_with_pts(amt, pts_rate, tot_months, pts)
...
def fixed_mortgage(amt, years, fixed_rate):
    tot_months = years*12
    fixed1 = Fixed(amt, fixed_rate, tot_months)
    morts = [fixed1]
...
def two_rate_mortgage(amt, years, var_rate1, var_rate2, var_months):
    tot_months = years*12
    two_rate = Two_rate(amt, var_rate2, tot_months, var_rate1, var_months)
    morts = [two_rate]
